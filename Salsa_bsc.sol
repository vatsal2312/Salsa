...
/*
Developed by the Salsa Valley team (salsavalley.com)
🌶 Website : https://salsatoken.com 
🌶 Twitter : https://twitter.com/SalsaToken 
🌶 Telegram : https://t.me/salsatoken 
🌶 Announcement : https://t.me/salsavalley_ann 

SALSA TOKEN features:
   4% fee auto add to the liquidity pool to locked forever when selling
   4% fee auto distribute to all holders
   Anti Whales feature prevents pump-dump-exit whales because they can destroy the systematic project development.
*/
...
contract Salsa is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "SALSA TOKEN";
    string private _symbol = "SALSA";
